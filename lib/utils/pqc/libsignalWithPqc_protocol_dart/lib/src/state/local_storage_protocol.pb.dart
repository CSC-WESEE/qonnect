...
class SessionStructure extends $pb.GeneratedMessage {
  factory SessionStructure({
    ...
    SessionStructurePendingPqkemPreKey? pendingPqkemPreKey,
    ...
    if (pendingPqkemPreKey != null) {
      _result.pendingPqkemPreKey = pendingPqkemPreKey;
    }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<SessionStructurePendingPqkemPreKey>(
        10,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'pendingPqkemPreKey',
        protoName: 'pendingPqkemPreKey',
        subBuilder: SessionStructurePendingPqkemPreKey.create)
    ..a<$core.int>(
        11,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$pb.TagNumber(10)
  SessionStructurePendingPqkemPreKey get pendingPqkemPreKey => $_getN(9);

  @$pb.TagNumber(10)
  set pendingPqkemPreKey(SessionStructurePendingPqkemPreKey v) {
    setField(10, v);
  }

  @$pb.TagNumber(10)
  $core.bool hasPendingPqkemPreKey() => $_has(9);

  @$pb.TagNumber(10)
  void clearPendingPqkemPreKey() => clearField(10);

  @$pb.TagNumber(10)
  SessionStructurePendingPqkemPreKey ensurePendingPqkemPreKey() => $_ensure(9);

  @$pb.TagNumber(11)
  $core.int get remoteRegistrationId => $_getIZ(10);
  ...
  @$pb.TagNumber(11)
  $core.bool hasRemoteRegistrationId() => $_has(10);

  @$pb.TagNumber(11)
  void clearRemoteRegistrationId() => clearField(11);

  @$pb.TagNumber(12)
  $core.int get localRegistrationId => $_getIZ(11);
  ...
  @$pb.TagNumber(12)
  $core.bool hasLocalRegistrationId() => $_has(11);

  @$pb.TagNumber(12)
  void clearLocalRegistrationId() => clearField(12);

  @$pb.TagNumber(13)
  $core.bool get needsRefresh => $_getBF(12);
  ...
  @$pb.TagNumber(13)
  $core.bool hasNeedsRefresh() => $_has(12);

  @$pb.TagNumber(13)
  void clearNeedsRefresh() => clearField(13);

  @$pb.TagNumber(14)
  $core.List<$core.int> get aliceBaseKey => $_getN(13);
  ...
  @$pb.TagNumber(14)
  $core.bool hasAliceBaseKey() => $_has(13);

  @$pb.TagNumber(14)
  void clearAliceBaseKey() => clearField(14);

  @$pb.TagNumber(15)
  $core.List<$core.int> get secretCipher => $_getN(14);
  ...
  @$pb.TagNumber(15)
  $core.bool hasSecretCipher() => $_has(14);

  @$pb.TagNumber(15)
  void clearSecretCipher() => clearField(15);
}
...
class PqkemPreKeyRecordStructure extends $pb.GeneratedMessage {
  factory PqkemPreKeyRecordStructure({
    $core.int? id,
    $core.List<$core.int>? publicKey,
    $core.List<$core.int>? privateKey,
    $core.List<$core.int>? signature,
  ...
  PqkemPreKeyRecordStructure._() : super();

  factory PqkemPreKeyRecordStructure.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory PqkemPreKeyRecordStructure.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  @override
  PqkemPreKeyRecordStructure clone() =>
      PqkemPreKeyRecordStructure()..mergeFromMessage(this);

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  @override
  PqkemPreKeyRecordStructure copyWith(
          void Function(PqkemPreKeyRecordStructure) updates) =>
      super.copyWith((message) => updates(message as PqkemPreKeyRecordStructure))
          as PqkemPreKeyRecordStructure; // ignore: deprecated_member_use
  @override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static PqkemPreKeyRecordStructure create() => PqkemPreKeyRecordStructure._();

  @override
  PqkemPreKeyRecordStructure createEmptyInstance() => create();

  static $pb.PbList<PqkemPreKeyRecordStructure> createRepeated() =>
      $pb.PbList<PqkemPreKeyRecordStructure>();

  @$core.pragma('dart2js:noInline')
  static PqkemPreKeyRecordStructure getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PqkemPreKeyRecordStructure>(create);
  static PqkemPreKeyRecordStructure? _defaultInstance;
...
class SessionStructurePendingPqkemPreKey extends $pb.GeneratedMessage {
  factory SessionStructurePendingPqkemPreKey({
    $core.int? pqkemPreKeyId,
    $core.List<$core.int>? baseKey,
    $core.int? signedPqkemPreKeyId,
  }) {
    final _result = create();
    if (pqkemPreKeyId != null) {
      _result.pqkemPreKeyId = pqkemPreKeyId;
    }
    if (baseKey != null) {
      _result.baseKey = baseKey;
    }
    if (signedPqkemPreKeyId != null) {
      _result.signedPqkemPreKeyId = signedPqkemPreKeyId;
    }
    return _result;
  }

  SessionStructurePendingPqkemPreKey._() : super();

  factory SessionStructurePendingPqkemPreKey.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory SessionStructurePendingPqkemPreKey.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names')
          ? ''
          : 'SessionStructure.PendingPqkemPreKey',
      package: const $pb.PackageName(
          $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'textsecure'),
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  @override
  SessionStructurePendingPqkemPreKey clone() =>
      SessionStructurePendingPqkemPreKey()..mergeFromMessage(this);

  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  @override
  SessionStructurePendingPqkemPreKey copyWith(
          void Function(SessionStructurePendingPqkemPreKey) updates) =>
      super.copyWith(
              (message) => updates(message as SessionStructurePendingPqkemPreKey))
          as SessionStructurePendingPqkemPreKey; // ignore: deprecated_member_use
  @override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static SessionStructurePendingPqkemPreKey create() =>
      SessionStructurePendingPqkemPreKey._();

  @override
  SessionStructurePendingPqkemPreKey createEmptyInstance() => create();

  static $pb.PbList<SessionStructurePendingPqkemPreKey> createRepeated() =>
      $pb.PbList<SessionStructurePendingPqkemPreKey>();

  @$core.pragma('dart2js:noInline')
  static SessionStructurePendingPqkemPreKey getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SessionStructurePendingPqkemPreKey>(create);
  static SessionStructurePendingPqkemPreKey? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get pqkemPreKeyId => $_getIZ(0);

  @$pb.TagNumber(1)
  set pqkemPreKeyId($core.int v) {
    $_setUnsignedInt32(0, v);
  }

  @$pb.TagNumber(1)
  $core.bool hasPqkemPreKeyId() => $_has(0);

  @$pb.TagNumber(1)
  void clearPqkemPreKeyId() => clearField(1);
  ...
  @$pb.TagNumber(3)
  $core.int get signedPqkemPreKeyId => $_getIZ(2);

  @$pb.TagNumber(3)
  set signedPqkemPreKeyId($core.int v) {
    $_setSignedInt32(2, v);
  }

  @$pb.TagNumber(3)
  $core.bool hasSignedPqkemPreKeyId() => $_has(2);

  @$pb.TagNumber(3)
  void clearSignedPqkemPreKeyId() => clearField(3);
}
