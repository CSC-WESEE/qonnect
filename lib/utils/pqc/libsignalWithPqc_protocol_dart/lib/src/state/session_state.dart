...
base class SessionState extends LinkedListEntry<SessionState> {
  ...
  Uint8List? get secretCipher =>
      Uint8List.fromList(_sessionStructure.secretCipher);

  set secretCipher(Uint8List? secretCipher) =>
      _sessionStructure.secretCipher = secretCipher!;
  ...
  UnacknowledgedPreKeyMessageItems getUnacknowledgedPreKeyMessageItems() {
    try {
      ...
      Optional<int> pqkemSignedOneTImePreKeyId;
      ...
      if (_sessionStructure.pendingPqkemPreKey.hasPqkemPreKeyId()) {
        pqkemSignedOneTImePreKeyId =
            Optional.of(_sessionStructure.pendingPqkemPreKey.pqkemPreKeyId);
      } else {
        pqkemSignedOneTImePreKeyId = const Optional.empty();
      }
      ...
      return UnacknowledgedPreKeyMessageItems(
        ...
        _sessionStructure.pendingPqkemPreKey.signedPqkemPreKeyId,
        pqkemSignedOneTImePreKeyId,
      );
    } on InvalidKeyException catch (e) {
      throw AssertionError(e);
...
class UnacknowledgedPreKeyMessageItems {
  ...
  final Optional<int> _pqkemSignedOneTimePreKeyId;
  ...
  Optional<int> getPqkemSignedOneTimePreKeyId() => _pqkemSignedOneTimePreKeyId;
}
